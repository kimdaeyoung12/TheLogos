...
양자역학에서 빛이 입자(Particle)이면서 동시에 파동(Wave)인 것처럼, 두 가지 상반된 속성이 모순이 아니라 온전한 실재를 설명하기 위해 필수적이라는 것이 <strong>상보성 원리</strong>입니다.
...
뇌과학자이자 신학자인 맥케이는 <strong>'논리적 비결정성(Logical Indeterminacy)'</strong>을 주장했습니다.
...
양자역학을 통해 예정과 자유의지를 설명하는 것은 <strong>"과학적 증명"이라기보다는 "풍성한 이해를 위한 유비(Analogy)"</strong>로 보는 것이 타당합니다. 
