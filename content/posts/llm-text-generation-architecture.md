...
<div class="llm-arch-container bg-[#121212] text-gray-200 p-4 md:p-8 font-sans text-sm md:text-base rounded-3xl my-8 overflow-hidden">
  <div class="max-w-5xl mx-auto space-y-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center border-b border-gray-700 pb-4">
      ...
      <div class="mt-4 md:mt-0 p-3 border border-gray-600 rounded-lg bg-[#1a1a1a] flex gap-4 text-xs">
    ...
    <section class="flex flex-col items-center">
      <div class="w-full max-w-3xl flex flex-col md:flex-row items-center justify-between gap-4">
        <div class="flex-1 flex items-center gap-2">
          ...
          <h2 class="text-lg font-semibold text-white border-0 m-0">임베딩 레이어</h2>
        </div>
        
        <div class="flex-[2] flex flex-col items-center">
          <div class="text-gray-300 mb-1">토큰 ID <span class="text-blue-300 ml-2">[2601, 318, 26110, 879, 30]</span></div>
          <i data-lucide="arrow-down" class="text-gray-500 my-1 w-4 h-4"></i>
          <div class="flex items-center gap-4 border border-purple-500 rounded p-2 text-purple-300 text-xs">
            <div>토큰<br/>임베딩</div>
          ...
          <i data-lucide="arrow-down" class="text-gray-500 my-1 w-4 h-4"></i>
          <div class="border border-gray-500 p-2 text-center text-xs">
            임베딩 행렬<br/>
            <span class="text-purple-300">(seq_len x d_model)</span>
          </div>
        </div>
        
        <div class="flex-1 text-orange-400 text-xs text-right">
    ...
    <section class="relative border-2 border-dashed border-gray-600 rounded-xl p-4 md:p-6 w-full max-w-4xl mx-auto">
      <div class="absolute -left-4 -top-4 bg-[#121212] px-2 flex items-center gap-2">
        <span class="text-xl font-bold text-gray-400">④</span>
        <h2 class="text-lg font-semibold text-white border-0 m-0">트랜스포머 블록</h2>
      ...
      <div class="flex flex-col lg:flex-row gap-6 mt-4">
          ...
          <div class="border border-blue-500 rounded-lg p-4 w-full relative">
            ...
            <div class="flex justify-center gap-4 mb-4 text-xs">
              ...
              <div class="flex flex-col justify-center items-center px-2">
                <i data-lucide="arrow-right" class="text-gray-500 w-4 h-4"></i>
              </div>
              ...
              <div class="text-center flex flex-col items-center">
                ...
                <div class="mt-2 border border-orange-400 text-orange-300 rounded px-2 py-1 flex items-center">
                  ...
                  <span class="border-l border-orange-400 pl-1 text-[10px]">(QKᵀ) / √dₖ</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="border border-blue-500 rounded-lg p-4 w-full flex flex-col items-center">
            ...
            <div class="flex items-center gap-2 text-xs">
              <div class="border border-purple-500 p-2 text-center rounded">
                선형층<br/><span class="text-purple-300 text-[10px]">(d_model x d_ff)</span>
              </div>
              <i data-lucide="arrow-right" class="text-gray-500 w-4 h-4"></i>
              ...
              <i data-lucide="arrow-right" class="text-gray-500 w-4 h-4"></i>
              <div class="border border-purple-500 p-2 text-center rounded">
                선형층<br/><span class="text-purple-300 text-[10px]">(d_ff x d_model)</span>
              </div>
            </div>
          </div>
        ...
        <div class="flex-1 flex flex-col gap-4 pl-4 lg:border-l border-dashed border-gray-600">
          ...
          <div class="border border-blue-500 rounded-lg p-3 text-xs">
            <h4 class="text-blue-300 font-bold mb-2 border-0 m-0">KV 캐시 <span class="text-gray-400 font-normal">(레이어별)</span></h4>
          ...
          <div class="text-orange-400 text-xs mt-4">
            KV 캐시는 시퀀스 길이에 비례해 증가 - 주요 메모리 병목
          </div>

          <div class="border border-orange-500 rounded p-2 text-xs text-orange-300 mt-4">
      ...
      <div class="absolute bottom-[-1.5rem] right-4 text-xs text-gray-500">x N 레이어 (GPT-4급 모델 기준)</div>
    </section>
    ...
    <section class="flex flex-col md:flex-row items-center justify-between w-full max-w-4xl mx-auto border-b border-gray-800 pb-8">
      <div class="flex items-center gap-2 w-full md:w-1/4 mb-4 md:mb-0">
        <span class="text-xl font-bold text-gray-400">⑤</span>
        <h2 class="text-sm font-semibold text-white border-0 m-0">선형층 + 소프트맥스<br/><span class="text-gray-400 font-normal">(LM 헤드)</span></h2>
      </div>
      
      <div class="flex items-center gap-2 text-xs w-full md:w-3/4 justify-center md:justify-start">
        <div class="border border-purple-500 p-2 text-center rounded">
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="flex justify-between w-full text-[10px] mt-1 text-gray-500"><span>1</span><span>128K</span></div>
        </div>
        
        <div class="flex flex-col items-center text-blue-400 mx-2">
          <span class="text-[10px]">소프트맥스</span>
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="flex items-end gap-1 h-8 border-b border-l border-gray-600 px-2 relative">
            <div class="absolute -left-4 top-0 text-[8px] text-gray-500">10⁰</div>
            <div class="absolute -left-4 bottom-2 text-[8px] text-gray-500">10⁻³</div>
    ...
    <section class="flex flex-col md:flex-row items-start w-full max-w-4xl mx-auto border-b border-gray-800 pb-8 mt-8">
      <div class="flex items-center gap-2 w-full md:w-1/4 mb-4 md:mb-0">
        <span class="text-xl font-bold text-gray-400">⑥</span>
        <h2 class="text-lg font-semibold text-white border-0 m-0">샘플링 전략</h2>
      </div>
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-2 w-full md:w-3/4">
        <div class="border border-green-500 rounded p-2 text-center flex flex-col items-center h-full">
          ...
          <div class="text-xs text-gray-300 mb-2">최대확률 선택<br/>↓ 샘플</div>
        ...
        <div class="border border-blue-500 rounded p-2 text-center flex flex-col items-center h-full">
          ...
          <div class="text-xs text-gray-300 mb-2">상위 K 토큰에서<br/>샘플</div>
          <div class="flex items-end gap-1 h-6 border-b border-gray-600">
        ...
        <div class="border border-orange-500 rounded p-2 text-center flex flex-col items-center h-full">
          ...
          <div class="text-xs text-gray-300 mb-2">누적확률 기준<br/>샘플</div>
          <div class="flex items-end gap-1 h-6 border-b border-gray-600 relative">
             ...
             <div class="absolute top-0 right-0 border-t border-r border-orange-400 w-4 h-4 rounded-tr"></div>
          </div>
        </div>

        <div class="border border-blue-300 rounded p-2 text-center flex flex-col items-center h-full">
          <div class="text-blue-300 font-bold text-[11px] mb-1">Temperature:</div>
          <div class="text-[10px] text-gray-300 mb-1">무작위성 조절</div>
          <div class="text-[10px] text-blue-200">T→0 결정적</div>
          <div class="text-[10px] text-blue-200">T→1 창의적</div>
    ...
    <section class="flex flex-col md:flex-row items-start w-full max-w-4xl mx-auto mt-8 relative">
      <div class="flex items-center gap-2 w-full md:w-1/4 mb-4 md:mb-0">
        <span class="text-xl font-bold text-gray-400">⑦</span>
        <div>
          <h2 class="text-lg font-semibold text-white border-0 m-0">추측 디코딩</h2>
          <span class="text-gray-400 text-sm">(속도 트릭)</span>
        </div>
      </div>
      
      <div class="flex items-center text-xs w-full md:w-3/4 flex-wrap gap-2 justify-center md:justify-start">
        ...
        <div class="border border-green-500 rounded p-2 text-center">
          ...
          <div class="flex gap-1 text-[10px] mt-2 justify-center">
        ...
        <div class="flex flex-col items-center">
           <div class="flex gap-2 mb-1">
             <div class="flex flex-col items-center text-green-400"><span class="text-lg">✓</span><span>중력</span><span class="text-[10px] text-gray-500 mt-1">26110</span><span class="text-[10px]">수락</span></div>
             <div class="flex flex-col items-center text-green-400"><span class="text-lg">✓</span><span>이란</span><span class="text-[10px] text-gray-500 mt-1">879</span><span class="text-[10px]">수락</span></div>
             <div class="flex flex-col items-center text-green-400"><span class="text-lg">✓</span><span>무엇</span><span class="text-[10px] text-gray-500 mt-1">318</span><span class="text-[10px]">거절</span></div>
             <div class="flex flex-col items-center text-red-400"><span class="text-lg">✗</span><span>a</span><span class="text-[10px] text-gray-500 mt-1">256</span><span class="text-[10px]">거절</span></div>
           </div>
        </div>
        ...
        <div class="border border-blue-500 rounded p-2 text-center">
          ...
          <div class="text-[10px] border border-blue-400 px-1 rounded bg-blue-900/30 text-blue-200 mt-1">fundamental</div>
          <div class="text-[10px] text-gray-500 mt-1">17042</div>
        </div>
